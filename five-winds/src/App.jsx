...
function BottomBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full">
      {/* Tab Button (Like a Browser Tab) */}
      <div className="flex items-center bg-gray-500 dark:bg-gray-600 px-4 py-2 rounded-t-md w-fit cursor-pointer"
        onClick={() => setActiveTab(activeTab === "timeline" ? "options" : "timeline")}
      >
        <span className="text-white text-sm font-semibold">
          {activeTab === "timeline" ? "Options" : "Timeline"}
        </span>
      </div>
